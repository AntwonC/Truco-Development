...
const Dashboard = () => {
    ...
    const joinRoomClicked = (roomNumber : Number, username : (string | null) ) : void => {
        ...
        {joinedRoom 
            ...
            <div className="dashboard-container">
                ...
                <Container>
                    ...
                    />
                    <Button onClick={() => {joinRoomClicked(roomNumber, user.username)}} disabled={roomNumber < 0}>Join</Button>
                </Container>
                </ThemeProvider>
